...
with open(args.wordcount_file) as wc_file:
    for line in wc_file:
        line = line.strip()
        data = line.split("|")
        if len(data) == 2:
...
print( "==========================================================================")
# print( "Average Topic Coherence = %.8f" % np.mean(mean_coherence_list))
print("{:.5f}".format(np.mean(mean_coherence_list)))
# print( "Median Topic Coherence = %.8f" % np.median(mean_coherence_list))
